package com.xw.bughome.middleware.dynamic.thread.pool.sdk.config;

import com.xw.bughome.middleware.dynamic.thread.pool.sdk.domain.DynamicThreadPoolService;
...
import com.xw.bughome.middleware.dynamic.thread.pool.sdk.registry.redis.RedisRegistry;
import com.xw.bughome.middleware.dynamic.thread.pool.sdk.trigger.job.ThreadPoolDataReportJob;
import com.xw.bughome.middleware.dynamic.thread.pool.sdk.trigger.listener.ThreadPoolConfigAdjustListener;
...
/**
 * 动态配置入口
 * Created by MaxWell on 2024/5/23 00:46
 */
@Configuration
@EnableScheduling
...
public class DynamicThreadPoolAutoConfig {
    ...
    @Bean
    public ThreadPoolConfigAdjustListener threadPoolConfigAdjustListener(IRegistry registry, IDynamicThreadPoolService dynamicThreadPoolService) {
        return new ThreadPoolConfigAdjustListener(registry, dynamicThreadPoolService);
    }

    @Bean(name = "dynamicThreadPoolRedisTopic")
    public RTopic dynamicThreadPoolRedisTopic(RedissonClient redissonClient,
